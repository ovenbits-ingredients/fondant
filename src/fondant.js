  ...
  $(function() {
    ...
    Fondant = (function() {
      ...
      Fondant.prototype.destroy = function(keep_changes) {
        ...
        this.makeUneditable();
        if (this.textarea) {
          this.replaceDivWithTextarea(keep_changes);
        }
      ...
      Fondant.prototype.insertToolbar = function() {
        ...
        if (typeof this.options.toolbar === 'function') {
          toolbarContent = this.options.toolbar.call(this.templates);
          return this.$element.prepend(toolbarContent);
